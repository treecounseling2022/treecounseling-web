...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "標準的個人心理輔導每節為 50 分鐘，伴侶輔導則為 80 分鐘。至於需要進行多少次，完全取決於您的議題性質、困擾程度以及您希望達到的諮商目標。有些單一的生涯抉擇可能只需 4-6 次諮商即可釐清；而深層的性格調整、長期創傷或關係修復，則可能需要數個月甚至更長期的定期陪伴。您可以與您的心理輔導人員共同討論並決定進程。",
  },
  {
    category: "privacy",
  ...
  },
  {
    ...
    answer: "為了尊重心理輔導人員的時間並保障其他候診個案的權益，若您需要更改或取消預約，請於「預約時間前至少 24 小時」聯絡工作室行政客服（可透過 WhatsApp 或 Email）。若於 24 小時內臨時取消，我們可能會酌收部分行政行政費用，敬請諒解。",
  },
  {
    category: "privacy",
